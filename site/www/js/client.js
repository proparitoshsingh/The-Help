...
var recStartTime;
var recElapsedTime;
var theHelpTheme = "neon"; // neon - dark - forest - ghost ...
...
function getHtmlElementsById() {
  ...
  themeSelect = getId("theHelpTheme");
 ...
 */
function setEraser() {
  theHelpTheme == "dark" ? (color = "#000000") : (color = "#ffffff");
  drawsize = 10;
  whiteboardColorPicker.value = color;
}
...
function disableAllPeers(element) {
  ...
  Swal.fire({
    background: swalBackground,
    position: "center",
    imageAlt: "theHelp-disable-" + element,
...
function getAbout() {
  ...
  Swal.fire({
    ...
    imageAlt: "theHelp-about",
    imageUrl: aboutImg,
    html: `
    <br/>
    <div id="about"><b>open source</b> project on<a href="https://www.github.com/proparitoshsingh/" target="_blank"><h1><strong> GitHub </strong></h1></a></div>
    <div id="author"><a href="https://www.linkedin.com/in/proparitoshsingh//" target="_blank">Author: Paritosh Singh</a></div><br>
    `,
    showClass: {
      popup: "animate__animated animate__fadeInDown",
    },
